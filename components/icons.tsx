...
export const PdfIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    ...
    <path d="M9.75 3.75a.75.75 0 00-1.5 0v16.5a.75.75 0 001.5 0V3.75z" />
    <path d="M14.25 2.25a.75.75 0 00-1.5 0v18a.75.75 0 001.5 0V2.25zM18.75 3.75a.75.75 0 00-1.5 0v16.5a.75.75 0 001.5 0V3.75zM20.25 8.25a.75.75 0 00-1.5 0v7.5a.75.75 0 001.5 0v-7.5z" />
    <path fillRule="evenodd" d="M3 3a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 3zm0 18a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75a.75.75 0 01-.75-.75z" clipRule="evenodd" />
  </svg>
);
...
export const ClearIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 9.75L14.25 12m0 0l2.25 2.25M14.25 12L12 14.25m-2.5-4.5L7.25 12m0 0l2.25 2.25M9.75 12l-2.25-2.25M15 4.5l.75 4.5l.75-4.5M15 4.5l-1.5 9M15 4.5l-4.5 9M15 4.5L6 13.5" />
    </svg>
);
